  ...
  server.registerTool(
    'validate_baseline',
    {
      ...
      description:
        ...
        'A series whose every control window was flat zero classifies as "baseline-all-zero" with a NaN "zScore" ' +
        'instead: that\'s a presence change (something that never happened is happening), not a deviation, and no ' +
        'meaningful z-score exists without baseline spread — judge it on "incidentStats" magnitude and ' +
